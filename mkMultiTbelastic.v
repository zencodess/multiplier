...
module mkMultiTbelastic(CLK,
  ...
  wire dut$EN_start, dut$RDY_result, dut$RDY_start;
  ...
  wire [63 : 0] _0_CONCAT_x_MINUS_1_4_5_MUL_0_CONCAT_y_MINUS_1_6_7___d18;
  wire [15 : 0] x__h428, x__h449;
  wire x_ULT_100___d7;

  // submodule dut
  mkElasticPipe dut(.CLK(CLK),
		    .RST_N(RST_N),
  ...
  // rule RL_rule_tb_2
  assign CAN_FIRE_RL_rule_tb_2 = dut$RDY_result && x_ULT_100___d7 ;
  assign WILL_FIRE_RL_rule_tb_2 = CAN_FIRE_RL_rule_tb_2 ;

  // rule RL_rule_tb_1
  assign CAN_FIRE_RL_rule_tb_1 = dut$RDY_start && x_ULT_100___d7 ;
  assign WILL_FIRE_RL_rule_tb_1 = CAN_FIRE_RL_rule_tb_1 ;

  // rule RL_stop
  assign CAN_FIRE_RL_stop = !x_ULT_100___d7 ;
  ...
  assign x$EN = CAN_FIRE_RL_rule_tb_1 ;

  // register y
  assign y$D_IN = y + 16'd1 ;
  assign y$EN = CAN_FIRE_RL_rule_tb_1 ;

  // submodule dut
  assign dut$start_m1 = x ;
  assign dut$start_m2 = y ;
  assign dut$EN_start = CAN_FIRE_RL_rule_tb_1 ;

  // remaining internal signals
  assign _0_CONCAT_x_MINUS_1_4_5_MUL_0_CONCAT_y_MINUS_1_6_7___d18 =
	     { 16'd0, x__h428 } * { 16'd0, x__h449 } ;
  assign x_ULT_100___d7 = x < 16'd100 ;
  assign x__h428 = x - 16'd1 ;
  assign x__h449 = y - 16'd1 ;
  ...
  begin
	...
	$display("    Result = %0d Expected = %0d",
		 dut$result,
		 _0_CONCAT_x_MINUS_1_4_5_MUL_0_CONCAT_y_MINUS_1_6_7___d18[31:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rule_tb_2 &&
	  dut$result !=
	  _0_CONCAT_x_MINUS_1_4_5_MUL_0_CONCAT_y_MINUS_1_6_7___d18[31:0])
